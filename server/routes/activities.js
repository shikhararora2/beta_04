...
import { incrementServiceProgress } from '../controllers/incrementServiceCount';

const router = express.Router();

// POST route to increment the service progress
router.post('/api/activity/increment', incrementServiceProgress);
